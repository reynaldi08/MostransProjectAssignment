...
//   return (
//     <div style={{ padding: '30px', margin: 'auto', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    
//       <h1>Characters by Location</h1>
//       <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel" style={{ border: '1px solid black', width: '100%', maxWidth: '375px', margin: 'auto', borderRadius: '12px', padding:'10px' }}>
...
//                 </div>
//                 <Button style={{ width: '200px', height: '40px', borderRadius: '48px', margin: '10px' }} onClick={() => openModal(location)}>See Characters</Button>
//                 <Button style={{ width: '200px', height: '40px', borderRadius: '48px', margin: '5px' }} variant="danger" onClick={() => handleDeleteLocation(location)}>Delete Location</Button>
//               </div>
//             </div>
//           ))}
//         </div>
...
//       <Button style={{ margin:'20px', width: '375px', height: '40px', borderRadius: '48px' }} onClick={resetLocations}>Reset All Location</Button>
...
const CharacterByLocation = () => {
  ...
  return (
    <div style={{ padding: '30px', margin: 'auto', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <Button style={{ margin: '20px', width: '375px', height: '40px', borderRadius: '48px' }} onClick={resetLocations}>Reset All Location</Button>
      <Modal show={showModal} onHide={closeModal} style={{ color: 'white', backgroundColor: '#5e9299' }}>
        ...
        <Modal.Body style={{ backgroundColor: '#5e9299' }}>
          {activeLocation && locations[activeLocation].map(char => (
            <div key={char.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
